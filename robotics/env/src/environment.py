...
class KukaEnv(gym.Env):
    ...
    Observation: Dictionary space containing:
                 - 'pixels': Image observation (H, W, 3)
                 - 'state': 21-dim vector = [joint_pos(7), joint_vel(7), ee_position(3), ee_orientation(4)]
                 - 'object_state': 9-dim pybullet object state
    """
    ...
    def __init__(self, render_mode=RenderMode.RGB_ARRAY.value):
        ...
        self.observation_space = spaces.Dict({
            ...
            "object_state": spaces.Box(low=obj_low, high=obj_high, shape=(9,), dtype=np.float32)
        })
    ...
    def step(self, action):
        ...
        # Extract ee_position for the info dict
    ...
    def _get_observation(self):
        ...
        # Return dictionary containing raw pixels and physics states
        return {
            "pixels": img,
            "state": physics_state,
